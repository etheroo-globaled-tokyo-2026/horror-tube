...
def describe_ens_action(label: str, ens_label: str, *, kind: str) -> str:
    ...
    if kind == "import":
        return (
            ...
            f"under parent {ens_label}.eth. Text keys: display_name, look, brief, injuries, status, icon. "
    ...
    if kind == "register":
        return (
            ...
            f"(display_name, look, brief, injuries, status, icon) under parent {ens_label}.eth."
        )
