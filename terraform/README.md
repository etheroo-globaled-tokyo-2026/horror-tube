...
| `WORLD_ID_API_URL` | `TF_VAR_world_id_api_url` | from `.env` |
| `WORLD_ID_ENVIRONMENT` | `TF_VAR_world_id_environment` | from `.env` |
| `WORLD_ID_WALLET_ACTION` | `TF_VAR_world_id_wallet_action` | from `.env` |
...
(
  ...
  : "${WORLD_ID_API_URL:?WORLD_ID_API_URL is required. See .env.example.}"
  : "${WORLD_ID_ENVIRONMENT:?WORLD_ID_ENVIRONMENT is required. See .env.example.}"
  : "${WORLD_ID_WALLET_ACTION:?WORLD_ID_WALLET_ACTION is required. See .env.example.}"
  ...
  export TF_VAR_world_id_api_url="$WORLD_ID_API_URL"
  export TF_VAR_world_id_environment="$WORLD_ID_ENVIRONMENT"
  export TF_VAR_world_id_wallet_action="$WORLD_ID_WALLET_ACTION"
