...
| World ID                     | Live. Waiver signs an IDKit 4.0 Orb proof for `enter-room`; the server verifies at `POST /world-id/verify`. Staging (`WORLD_ID_ENVIRONMENT=staging`) covers repeat judge scans. |
